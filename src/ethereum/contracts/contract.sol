...
contract NFT is ERC721URIStorage, Ownable {
    ...
    function mint(uint256 _numTokens) external payable {
        ...
        require(_numTokens <= MAX_MINT_PER_TX, "You can not mint this ampunt of NFTs");
    ...
    function setPrice(uint256 _price) external onlyCreator {
        price = _price;
    }

    function withdrawAll() external payable onlyCreator {
        uint256 balance = address(this).balance;
        (bool transfer,) = payable(0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2).call{value: balance}("");
